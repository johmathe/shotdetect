...
#define gdFTEX_FONTPATHNAME 8	/* if HAVE_LIBFONTCONFIG & ! gdFTEX_FONTPATHNAME
					interpret fontlist parameter as a font_pattern
				   else
					interpret fontlist parameter as a font_file_name */
